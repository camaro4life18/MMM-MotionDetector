...
| `deviceId`            | (optional) specify which camera to use in case multiple exist in the system.<br> Find out the ID by running `navigator.mediaDevices.enumerateDevices()` in your browsers web console.
